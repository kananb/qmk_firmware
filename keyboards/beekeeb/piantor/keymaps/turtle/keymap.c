...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER3] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_NO, KC_NO, KC_NO, KC_EQL, KC_ASTR, KC_PLUS, KC_TRNS, KC_NO, KC_DOT, KC_4, KC_5, KC_6, KC_0, KC_NO, KC_NO, KC_NO, KC_SLSH, KC_MINS, KC_TRNS, KC_NO, KC_COLN, KC_1, KC_2, KC_3, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_NO),
...
bool combo_should_trigger(uint16_t combo_index, combo_t *combo, uint16_t keycode, keyrecord_t *record) {
    switch (combo_index) {
        ...
        case COMBO_UNDS:
        case COMBO_QUOT:
            return highest_layer == ALPHA;
        case COMBO_CARET:
            return highest_layer == SYM_OPS;
        case COMBO_BSPC_LHS:
        case COMBO_ENT_LHS:
            return highest_layer == MOD;
    }
